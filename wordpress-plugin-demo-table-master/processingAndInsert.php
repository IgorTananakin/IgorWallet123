...
//			SELECT wp_wallet_transaction.id 
//FROM wp_wallet_transaction 
//INNER JOIN wp_wallet 
//ON wp_wallet.id_user = wp_wallet_transaction.wallet_id 
//WHERE wp_wallet_transaction.match_id = 123
			
			
//			$sql = "SELECT * FROM wp_wallet_transaction WHERE match_id = $match_id";
//			$result = mysqli_query( $conn, $sql )or die( "database error:" . mysqli_error( $conn ) );
